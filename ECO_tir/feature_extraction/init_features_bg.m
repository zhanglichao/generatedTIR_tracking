function [features, gparams, feature_info] = init_features_bg(features, gparams, is_color_image, img_sample_sz, size_mode)
...
if cnn_feature_ind > 0
    ...
    % for resnet
    feature_info.img_sample_sz = [224 224];
    feature_info.img_input_sz = [224 224];
    % Set the input size
...
% for resnet
features{1}.fparams.net.meta.normalization.imageSize = [224 224 3 1];
feature_info.data_sz(1,:) = features{1}.fparams.data_sz;