function results = tracker_hollucination(params)
...
[features, global_fparams, feature_info] = init_features_hallu(features, global_fparams, is_color_image, img_sample_sz, 'odd_cells');
