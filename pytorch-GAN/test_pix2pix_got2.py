...
pathbase = '/home/lichao/tracking/datasets/GOT-10k/train'
...
for folder1 in level1:
    ...
    for i, data in enumerate(dataset):
        ...
        #pdb.set_trace()
        resimg_path = img_path[0].replace('GOT-10k','GOT-10k_i_'); #resimg_path=resimg_path.replace('jpg','JPEG')
